...
<div class="messages--wrap message-wrap-status">
    <div class="row  profile-nav">
        <div class="col-md-7">
            <div class="nav-profile-userpic">
                                        <img src="img/avatar1.jpg" class="img-responsive" alt=""> </div>
        </div>
        <div class="col-md-5">
            <ul class="nav-pills profile-nav-pills">
                <li class="active">
                    <router-link to="/timeline">
                        <i class="icon-home"></i> Timeline </router-link>
                </li>
                <li>
                    <router-link to="/profile">
                        <i class="icon-settings"></i> Account Settings </router-link>
                </li>      
            </ul>
        </div>
    </div>
